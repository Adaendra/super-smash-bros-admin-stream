...
socket.addEventListener('message', function (event) {
    ...
    if (dataJs.presentation != null) {
        ...
        document.getElementById("nomPersoJ1").innerHTML = dataJs.presentation.nomPersoJ1;
        ...
        document.getElementById("nomPersoJ2").innerHTML = dataJs.presentation.nomPersoJ2;
